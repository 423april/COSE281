...
% 0.1*S + 0.65*E + 0.05*C = 10*10^9 dollar's worth of steel product
% 0.04*S + 0.2*E + 0.1*C = 15*10^9 dollar's worth of energy product
% 0.6*S + 0.2*E + 0.05*C = 20*10^9 dollar's worth of car product
...
x = GaussElimination(eye(3) - transpose(M), b)
