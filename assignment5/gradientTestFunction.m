...
%% Question
%   If your step size is too large, the optimisation will not converge. 
...
%   into the script.
% Answer
%   From lambda = 0.34 onwards, the optimisation does not converge. 
...
% Answer
%   The minimum number of steps is 31 (when lambda = 0.24).
